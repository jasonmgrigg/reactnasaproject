              ...
              <div className="card-block">
                ...
                <form onSubmit={this.handleFormSubmit}>
                  <div className="form-group">
                    <textarea className="form-control" name="comment"  rows="3" type="text" onChange={this.handleCommentTextChange} value={this.state.commentText}/>
                  </div>
                  <div className="form-group">
                      <input className="form-control col-md-3" placeholder="Enter your name here" name="name"  type="text" value={this.state.commentAuthor} onChange={this.handleNameChange}/>
                  </div>
